...
// user include files
//#include "Demo/DemoAnalyzer/plugins/miniAODmuons.h"
...
#include "DataFormats/PatCandidates/interface/PackedCandidate.h" // very important to MiniAOD
